					...
					<ul class="main-nav-list">
						...
						<li>
							...
							<ul class="sub-menu">
								...
								<li><a href="qna.html">질문 및 답변(Q&A)</a></li>
			...
			<div class="content-area">
                ...
                <div class="board-area">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="article" items="${articleList}">
								<tr>
									...
									<td class="board-list-title"><a href="/EightLibrary/content.do?num=${article.b2_num}&pageNum=${pgList.currentPage}">
									...
									<td class="board-list-date">${article.b2_date}</td>
                                ...
                                <td class="board-list-title">
                                    <a href="#">
                                        <div class="board-default-cut-strings">
                                            ...
                                            Re:학술 논문 다운로드시에 1페이지만 다운로드가 되어 문의드립니다.
                                            <img src="img/sub/icon-lock.png" alt="비밀글">		<span class="board-default-new-notify">New</span>
                                        </div>
                                        <div class="board-mobile-contents">
                                            <span class="contents-item">관리자</span>
                                            <span class="contents-item">2019.09.16</span>
                                            <span class="contents-item">4</span>
                                        </div>
                                    </a>
                                </td>
                                <td class="board-list-user">관리자</td>
                                <td class="board-list-date">2019.09.16</td>
                                <td class="board-list-view">4</td>
                            </tr> -->
        			...
        			<div class="btn-area tar mt0">
                    	<a href="boardRegist.html" role="button" class="btn deep-blue">글쓰기</a>
                	</div>
                </div>
			</div>
		</div>
