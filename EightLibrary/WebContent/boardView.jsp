		...
		<div class="inner-max">
			<div class="content-area">
                ...
                <div class="board view-area">
                    <div class="view-head">
                        <h2 class="article-title">
                            ${article.b1_title }<!-- <span class="item-icon new">새 글</span> -->
                        </h2>
                        <div class="article-meta">
                            <dl class="list colon inline">
                                ...
                                <dd class="date r-sep"><fmt:formatDate value="${article.b1_date}" pattern="yyyy-MM-dd" /></dd>
                                <dt class="view">조회</dt>
                                <dd class="view">${article.b1_view}</dd>
                            </dl>
                        </div>
                    </div>
                    <div class="view-body">
                ...
                <div class="btn-area tar">
                    ...
                    <a href="board.do" role="button" class="btn blue-gray">목록보기</a>
                </div>
			</div>
		</div>
	</div>
